...
import {option1, option2, option3, option4} from './PositionComponents/data.js'
import Singleton from './PositionComponents/SingleItem.js'
 
function PositionC({Aircraft}){
        var Option;
