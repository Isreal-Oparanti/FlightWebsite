...
import {option1, option2, option3, option4} from './MaintananceComponents/data.js'
import Singleton from './MaintananceComponents/SingleItem.js'
 
function Maintanance({Aircraft}){
        var Option;
